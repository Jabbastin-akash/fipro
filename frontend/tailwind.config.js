  ...
  theme: {
    extend: {
      colors: {
        ...
        // Verdict colors with enhanced gradients
        'verdict-true': {
          50: '#f0fdf4',
          100: '#dcfce7',
          200: '#bbf7d0',
        ...
        'verdict-unverified': '#f59e0b',
        'verdict-requires-investigation': '#8b5cf6',
        'verdict-requires-context': '#06b6d4',
        'verdict-partially-true': '#f97316',
      ...
      backgroundImage: {
        ...
        'success-gradient': 'linear-gradient(135deg, #667eea, #764ba2)',
